...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldPermissions>
        ...
        <field>MedicineTrail__c.MedicineID__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>MedicineTrail__c.Trailphase__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>MedicineTrail__c.Trailstatus__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <layoutAssignments>
        <layout>MedicineTrail__c-MedicineTrail Layout</layout>
    </layoutAssignments>
    <objectPermissions>
        ...
        <object>MedicineTrail__c</object>
        <viewAllRecords>true</viewAllRecords>
    </objectPermissions>
    <tabVisibilities>
        <tab>MedicineTrail__c</tab>
